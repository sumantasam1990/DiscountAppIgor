...
/***/ 3128:
/*!*****************************************************************!*\
  !*** ./src/app/components/cart-follow/cart-follow.component.ts ***!
  \*****************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "CartFollowComponent": () => (/* binding */ CartFollowComponent)
/* harmony export */ });
...
/* harmony import */ var _cart_follow_component_html_ngResource__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./cart-follow.component.html?ngResource */ 382);
/* harmony import */ var _cart_follow_component_scss_ngResource__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./cart-follow.component.scss?ngResource */ 3568);
...
let CartFollowComponent = class CartFollowComponent {
  constructor(http, router) {
    this.http = http;
    this.router = router;
    this.userid = '0';
    this.followCartURL = _environments_environment__WEBPACK_IMPORTED_MODULE_3__.environment.serverAPI + 'profile/follow/carts';
    this.followCartURLPublic = _environments_environment__WEBPACK_IMPORTED_MODULE_3__.environment.serverAPI + 'profile/follow/carts/';
    this.loading = false;
    this.data = [];
  }
  ...
  getData() {
    ...
    return (0,_Users_sumanta_Desktop_DiscountApp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      _this2.loading = true;
      yield _this2.http.get(_this2.followCartURL).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.delay)(250), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.retry)(3)).toPromise().then(res => {
        _this2.loading = false;
        _this2.data = res.follow_carts;
  ...
  getDataPublic() {
    ...
    return (0,_Users_sumanta_Desktop_DiscountApp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      _this3.loading = true;
      yield _this3.http.get(_this3.followCartURLPublic + _this3.userid).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.delay)(250), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.retry)(3)).toPromise().then(res => {
        _this3.loading = false;
        _this3.data = res.follow_carts;
        console.log(res.follow_carts[0].followings[0].name);
      }, error => {
        alert('Error! ' + error);
      });
...
CartFollowComponent.ctorParameters = () => [{
  type: _angular_common_http__WEBPACK_IMPORTED_MODULE_6__.HttpClient
}, {
  type: _angular_router__WEBPACK_IMPORTED_MODULE_7__.Router
}];

CartFollowComponent.propDecorators = {
  userid: [{
    type: _angular_core__WEBPACK_IMPORTED_MODULE_8__.Input
  }]
};
CartFollowComponent = (0,tslib__WEBPACK_IMPORTED_MODULE_9__.__decorate)([(0,_angular_core__WEBPACK_IMPORTED_MODULE_8__.Component)({
  selector: 'app-cart-follow',
  template: _cart_follow_component_html_ngResource__WEBPACK_IMPORTED_MODULE_1__,
  styles: [_cart_follow_component_scss_ngResource__WEBPACK_IMPORTED_MODULE_2__]
})], CartFollowComponent);
...
const attachComponent = /*#__PURE__*/function () {
  var _ref = (0,_Users_sumanta_Desktop_DiscountApp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (delegate, container, component, cssClasses, componentProps, inline) {
    var _a;
...
const CoreDelegate = () => {
  ...
  const attachViewToDom = /*#__PURE__*/function () {
    var _ref2 = (0,_Users_sumanta_Desktop_DiscountApp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (parentElement, userComponent, userComponentProps = {}, cssClasses = []) {
      var _a, _b;
...
const getScrollElement = /*#__PURE__*/function () {
  var _ref = (0,_Users_sumanta_Desktop_DiscountApp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (el) {
    if (isIonContent(el)) {
      yield new Promise(resolve => (0,_helpers_4d272360_js__WEBPACK_IMPORTED_MODULE_1__.c)(el, resolve));
...
/***/ 3568:
/*!******************************************************************************!*\
  !*** ./src/app/components/cart-follow/cart-follow.component.scss?ngResource ***!
  \******************************************************************************/
/***/ ((module) => {

module.exports = "ion-img::part(image) {\n  border-radius: 100% !important;\n  border: 2px solid #fca3a3;\n}\n\nh2, p {\n  font-weight: bold !important;\n}\n\n.margin {\n  margin-top: 10px !important;\n}\n\n.flex {\n  display: flex;\n  flex-direction: row;\n  justify-content: space-between;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
...
/***/ 382:
/*!******************************************************************************!*\
  !*** ./src/app/components/cart-follow/cart-follow.component.html?ngResource ***!
  \******************************************************************************/
/***/ ((module) => {

module.exports = "<ion-progress-bar *ngIf=\"loading\" type=\"indeterminate\"></ion-progress-bar>\n<ion-row>\n  <ion-col>\n    <h2>\n      <ion-text color=\"\">\n        Cart Follows\n      </ion-text>\n    </h2>\n  </ion-col>\n\n</ion-row>\n\n<ion-row *ngIf=\"data.length > 0\">\n  <ion-col size=\"4\" *ngFor=\"let cart of data\">\n\n    <ion-img (click)=\"profileScreen(cart.followings[0]?.id);\" *ngIf=\"cart.followings[0].photo === '' || cart.followings[0].photo === 'https://cartingly.com//' || cart.followings[0].photo === 'https://cartingly.com'\" class=\"pro-pic\" src=\"https://cdn-icons-png.flaticon.com/128/149/149071.png\"></ion-img>\n\n    <ion-img (click)=\"profileScreen(cart.followings[0]?.id);\" *ngIf=\"cart.followings[0].photo !== '' && cart.followings[0].photo !== 'https://cartingly.com//' && cart.followings[0].photo !== 'https://cartingly.com'\" class=\"pro-pic\" [src]=\"cart.followings[0].photo\"></ion-img>\n\n    <div class=\"margin\">\n      <ion-label>\n        <h4>{{ cart.followings[0]?.name }}</h4>\n<!--        <p>{{cart.opens}} Opens</p>-->\n      </ion-label>\n    </div>\n<!--    <ion-button fill=\"clear\" size=\"small\">-->\n<!--      <ion-icon slot=\"start\" name=\"trash-outline\"></ion-icon> Unfollow-->\n<!--    </ion-button>-->\n  </ion-col>\n</ion-row>\n\n<ion-row *ngIf=\"data.length === 0\">\n  <ion-col>\n    <p>\n      <ion-text>\n        No cart found.\n      </ion-text>\n    </p>\n  </ion-col>\n</ion-row>\n\n<ion-row *ngIf=\"data.length > 0\">\n<!--  <ion-col size=\"6\">-->\n<!--    <ion-button fill=\"clear\">-->\n<!--      <ion-icon slot=\"start\" name=\"trash-outline\"></ion-icon> Unfollow-->\n<!--    </ion-button>-->\n<!--  </ion-col>-->\n\n<!--  <ion-col size=\"12\">-->\n<!--    <ion-button color=\"medium\" fill=\"clear\" expand=\"full\">-->\n<!--      More-->\n<!--    </ion-button>-->\n<!--  </ion-col>-->\n</ion-row>\n";
